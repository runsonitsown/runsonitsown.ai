# Business Overview — TJ's AI Consulting & Automation Venture
# Working name: TBD (not yet chosen)
...
- Custom GPTs
- Second brain/intelligent workbench with Claude Cowork
...
- **Hermes agents on TJ's personal VPS** — agent workloads for this business (this file is their standing context)
